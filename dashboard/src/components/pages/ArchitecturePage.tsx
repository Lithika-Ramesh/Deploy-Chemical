...
export function ArchitecturePage() {
  return (
    <motion.div className="px-3 py-4 sm:px-4 lg:px-6">
      ...
      <GlassPanel
        ...
        subtitle="Landscape view · diagram fits the panel · alarm highlight"
        accent="cyan"
        delay={0}
      >
        <figure className="relative w-full max-w-full p-0 sm:p-2">
          <motion.div
            className="@container relative h-[min(56dvh,560px)] w-full overflow-hidden rounded-xl border border-white/[0.06] sm:h-[min(60dvh,600px)]"
            style={{ backgroundColor: DASH_BG }}
          >
            <motion.div className="absolute inset-0 flex items-center justify-center p-1 sm:p-2">
              <div className="relative inline-flex origin-center -rotate-270">
                ...
                <img
                  ...
                  className="block h-auto w-auto max-h-[min(100cqw,96vw)] max-w-[min(100cqh,56dvh)] object-contain object-center mix-blend-multiply contrast-[1.06] sm:max-w-[min(100cqh,60dvh)]"
                  draggable={false}
                />
