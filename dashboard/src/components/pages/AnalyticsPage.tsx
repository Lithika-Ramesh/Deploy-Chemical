...
export function AnalyticsPage() {
  ...
  const pipelineHealthCopy = useMemo(
    () => ({
      ...
      trail:
        "Trend and attribution charts follow the in-browser mock twin. You can later load static JSON (e.g. exported notebook metrics) without a separate backend.",
    }),
    [],
  );
    ...
    <div className="px-3 py-4 sm:px-4 lg:px-6">
      <header className="mb-6">
        ...
        <p className="mt-1 max-w-2xl text-sm text-slate-500">
          Model health, attribution, and fault-family probabilities are driven by
          the in-browser twin for this build — add static artifacts or your own
          data layer when you want real pipeline numbers on this page.
        </p>
      </header>
